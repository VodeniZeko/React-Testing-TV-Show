...
test("select the season test", async () => {
...
//   const { getByTestId } = render(<App onChange={handleChange} />);
//   const input = getByTestId("url");
//   input.value = "Select a season";
...
//   // await wait(() => {
//   //   getByTestId("episodes-test-id");
//   // });
//   // expect(queryAllByTestId("episodes-list")).toHaveLength(26);
// });
